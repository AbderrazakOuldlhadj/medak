...
def fetch_joop_homme():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\JOOP HOMME EDT 125ML"
    os.makedirs(target_dir, exist_ok=True)

    urls = [
        'https://odorem-dz.com/produit/joop-homme-200ml-edt/',
        'https://cdn.notinoimg.com/detail_main_hq/joop/johmcdm_aedt10-01/joop-homme___250515.jpg',
        'https://cdn.notinoimg.com/detail_main_hq/joop/johmcdm_aedt10-02_/joop-homme___250515.jpg'
    ]
    ...
    img_urls.append(urls[1])
    img_urls.append(urls[2])
    ...
    print(f"Done! Successfully saved {saved} authentic Joop! Homme EDT 125ml photos into JOOP HOMME EDT 125ML/")
