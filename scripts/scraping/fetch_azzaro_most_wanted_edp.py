...
def fetch_azzaro_most_wanted_edp():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\AZZARO THE MOST WANTED EDP 100ML"
    os.makedirs(target_dir, exist_ok=True)

    urls = [
        'https://odorem-dz.com/produit/azzaro-the-most-wanted-eau-de-parfum-intense-100ml/'
    ]
    ...
    print(f"Done! Successfully saved {saved} authentic Azzaro The Most Wanted EDP 100ml photos into AZZARO THE MOST WANTED EDP 100ML/")

if __name__ == '__main__':
    fetch_azzaro_most_wanted_edp()
