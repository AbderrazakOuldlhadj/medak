...
def fetch_spicebomb_dark_leather():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\SPICE BOMP DARK LEATHER EDP 90ML"
    ...
    url = 'https://odorem-dz.com/produit/spicebomb-dark-leather-90ml-edp/'
    ...
    print(f"Done! Successfully saved {saved} authentic Spicebomb Dark Leather EDP 90ml photos into SPICE BOMP DARK LEATHER EDP 90ML/")

if __name__ == '__main__':
    fetch_spicebomb_dark_leather()
