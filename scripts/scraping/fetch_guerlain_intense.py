...
def fetch_guerlain_intense():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\GUERLAIN L'HOMME IDEAL INTENSE EDP 100ML"
    os.makedirs(target_dir, exist_ok=True)

    urls = [
        'https://odorem-dz.com/produit/lhomme-ideal-lintense-100ml-edp/'
    ]
    ...
    print(f"Done! Successfully saved {saved} authentic Guerlain L'Homme Idéal L'Intense photos into GUERLAIN L'HOMME IDEAL INTENSE EDP 100ML/")

if __name__ == '__main__':
    fetch_guerlain_intense()
