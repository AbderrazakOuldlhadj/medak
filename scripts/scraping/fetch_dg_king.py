...
def fetch_dg_king():
    target_dir = r'c:\Users\msipc\Desktop\products\parfums\assets\product_images\DOLCE GABBANA KING EDP 100 ML'
    ...
    urls = [
        'https://odorem-dz.com/produit/k-dolce-gabbana-eau-de-parfum-100ml/',
        'https://odorem-dz.com/produit/k-by-dolce-gabbana-parfum-100ml/'
    ]
    ...
    print(f'Done! Successfully saved {saved} authentic K by Dolce & Gabbana EDP photos into DOLCE GABBANA KING EDP 100 ML/')
