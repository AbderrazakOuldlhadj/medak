...
def fetch_hermes_h24():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\HERMES H24 EDT 100ML"
    os.makedirs(target_dir, exist_ok=True)

    urls = [
        'https://odorem-dz.com/produit/h24-eau-de-toilette-100ml/'
    ]
    ...
    print(f"Done! Successfully saved {saved} authentic Hermès H24 EDT photos into HERMES H24 EDT 100ML/")
