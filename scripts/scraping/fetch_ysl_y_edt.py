...
def fetch_ysl_y_edt():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\YVES SAINT LAURENT Y EDT 100ML"
    os.makedirs(target_dir, exist_ok=True)

    urls = [
        'https://odorem-dz.com/produit/y-eau-de-toilette-yves-saint-laurent-100ml/'
    ]
    ...
    print(f"Done! Successfully saved {saved} authentic YSL Y EDT 100ml photos into YVES SAINT LAURENT Y EDT 100ML/")
