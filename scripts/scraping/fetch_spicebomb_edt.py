...
def fetch_spicebomb_edt():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\SPICE BOMP EDT 90ML"
    ...
    urls = [
        'https://odorem-dz.com/produit/spicebomb-eau-de-toilette-90ml/',
        'https://media.sephora.eu/PIM/763067_main.jpg?scaleWidth=1000&scaleMode=fit',
        'https://media.sephora.eu/PIM/763067_1.jpg?scaleWidth=1000&scaleMode=fit',
        'https://media.sephora.eu/PIM/763067_2.jpg?scaleWidth=1000&scaleMode=fit'
    ]
    ...
    print(f"Done! Successfully saved {saved} authentic Spicebomb EDT 90ml photos into SPICE BOMP EDT 90ML/")
