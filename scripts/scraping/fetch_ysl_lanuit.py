...
def fetch_ysl_lanuit():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\YVES SAINT LAURENT LA NUIT DE L'HOMME EDT 100ML"
    os.makedirs(target_dir, exist_ok=True)

    urls = [
        'https://odorem-dz.com/produit/la-nuit-de-lhomme-eau-de-toilette-100ml/'
    ]
    ...
    print(f"Done! Successfully saved {saved} authentic YSL La Nuit De L'Homme EDT 100ml photos into YVES SAINT LAURENT LA NUIT DE L'HOMME EDT 100ML/")
