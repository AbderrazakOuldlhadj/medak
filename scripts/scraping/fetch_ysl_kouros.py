...
def fetch_ysl_kouros():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\YVES SAINT LAURENT KOUROS EDT 100ML"
    os.makedirs(target_dir, exist_ok=True)

    urls = [
        'https://odorem-dz.com/produit/kourous-eau-de-toilette-100ml/'
    ]
    ...
    print(f"Done! Successfully saved {saved} authentic YSL Kouros EDT 100ml photos into YVES SAINT LAURENT KOUROS EDT 100ML/")
