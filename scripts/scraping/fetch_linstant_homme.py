...
def fetch_linstant_homme():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\L'INSTANT HOMME EDP 100ML"
    os.makedirs(target_dir, exist_ok=True)

    urls = [
        'https://odorem-dz.com/produit/linstant-guerlain-homme-100ml-edp/',
        'https://cdn.notinoimg.com/detail_main_hq/guerlain/3346470304895_01/linstant-de-guerlain-pour-homme___250515.jpg',
        'https://cdn.notinoimg.com/detail_main_hq/guerlain/3346470304895_02_/linstant-de-guerlain-pour-homme___250515.jpg',
        'https://cdn.notinoimg.com/detail_main_hq/guerlain/3346470304895_03_fr_be/linstant-de-guerlain-pour-homme___240910.jpg'
    ]
    ...
    # Add Notino direct CDN images
    img_urls.extend(urls[1:])
    ...
    print(f"Done! Successfully saved {saved} authentic Guerlain L'Instant Pour Homme EDP 100ml photos into L'INSTANT HOMME EDP 100ML/")

if __name__ == '__main__':
    fetch_linstant_homme()
