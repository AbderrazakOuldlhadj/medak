...
def fetch_kenzo_intense():
    target_dir = r"c:\Users\msipc\Desktop\products\parfums\assets\product_images\KENZO INTENSE EDT 100ML"
    ...
    url = 'https://odorem-dz.com/produit/kenzo-homme-eau-de-toilette-intense-100ml/'
    ...
    print(f"Done! Successfully saved {saved} authentic Kenzo Homme Intense EDT 100ml photos into KENZO INTENSE EDT 100ML/")
