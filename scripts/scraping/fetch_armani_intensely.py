...
def fetch_armani_intensely():
    target_dir = r'c:\Users\msipc\Desktop\products\parfums\assets\product_images\EMPORIO ARMANI STRONGER WITH YOU INTENSELY EDP 100ML'
    os.makedirs(target_dir, exist_ok=True)

    urls = [
        'https://odorem-dz.com/produit/stronger-with-you-intensely-100ml-edp/'
    ]
    ...
    print(f'Done! Successfully saved {saved} authentic Stronger With You Intensely photos into EMPORIO ARMANI STRONGER WITH YOU INTENSELY EDP 100ML/')

if __name__ == '__main__':
    fetch_armani_intensely()
